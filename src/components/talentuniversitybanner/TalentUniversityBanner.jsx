...
>
  ...
  {/* Content */}
  <div className="relative z-10 w-full px-5 sm:px-10 md:px-16 py-10 flex flex-col md:flex-row justify-between items-start md:items-center text-white gap-6">
